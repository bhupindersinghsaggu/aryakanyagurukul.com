...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" style="margin-top: 70px;">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="upstudy-hero-section-06 d-flex align-items-center section" style="background-image: url(assets/images/gold1.jpg);">
                <div class="container">
        ...
        <div class="carousel-item">
            <div class="upstudy-hero-section-06 d-flex align-items-center section" style="background-image: url(assets/images/slider/456.jpg);">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-8 col-md-10">
                        </div>
        ...
        <div class="carousel-item">
            <div class="upstudy-hero-section-06 d-flex align-items-center section" style="background-image: url(assets/images/slider/5.png);">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-8 col-md-10">
                        </div>
        ...
        <div class="about-wrap">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6" style="
                    ...
                    <iframe src="https://curtina.in/_EazySchool/Formsweb/NewsEvents.aspx?AppId=akgss&cdn=http://curtina.in/akgss" height="500" width="600"></iframe>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-blog text-center">
                        <div class="blog-img">
                            <a href="biology-lab.php"><img src="assets/images/labs/bio.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-blog text-center">
                        <div class="blog-img">
                            <a href="physics.php"><img src="assets/images/labs/physics_lab.jpg" alt=""></a>
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-blog text-center">
                        <div class="blog-img">
                            <a href="chemistry.php"><img src="assets/images/labs/chem.jpg" alt=""></a>
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-blog text-center">
                        <div class="blog-img">
                            <a href="smart-classes.php"><img src="assets/images/labs/computer.jpg" alt=""></a>
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="single-blog text-center">
                        <div class="blog-img">
                            <a href="art-lab.php"><img src="assets/images/labs/health-center.jpg" alt=""></a>
                        </div>
                        <div class="blog-content">

                            <h3 class="title"><a href="labs.php">Health Center</a></h3>
    ...
    <div class="container">
        ...
        <div class="cta-wrap">
            <div class="row align-items-center">
                ...
                <div class="col-xl-2">
                    <div class="cta-btn">
                        <a class="btn" href="enquiry.php">Inquiry
                            Online</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="category-wrap">
            ...
            <div class="category-content-wrap">
                ...
                <div class="row">
                    <iframe src="https://curtina.in/_EazySchool/crescent/PhotoGallery.aspx?AppId=akgss&cdn=http://curtina.in/akgss
