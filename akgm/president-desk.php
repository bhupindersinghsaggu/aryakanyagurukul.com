        ...
        <div class="row">
                ...
                <div class="courses-details">
                    <div class="courses-card">
                        ...
                        <p>
                            ...
                            At our Gurukul believe in nurturing young minds nith knowledge, discipline and values that
                            shape responsible citizens. Our mission is to empower girls with skills, wisdom and
                            confidence to excel in all walks of life .Remember education is not just about acquiring
                            knowledge but about developing a mindset of curiosity. Believe in yourself, work hard and
                            success will follow.
                        </p>
                        <p>
                        ...
                        <h3>Sukhbir Singh Mann, Advocate
                        </h3>
            ...
            <div class="col-lg-4">
                ...
                <div class="enroll-courses">
                    ...
                    <div class="list">
                        <ul>
                            <li><span><a href="introduction.php">Introduction </span></a><i
                                    class="flaticon-paper-plane"></i></li>
                            <li><span><a href="president-desk.php"> President’s Desk</span></a><i
                                    class="flaticon-paper-plane"></i></li>

                            <li><span><a href="governing-body.php">Governing Body </span></a><i
                                    class="flaticon-paper-plane"></i></li>
                            <li><span><a href="principal-message.php">Principal’s Message</span></a><i
                                    class="flaticon-paper-plane"></i></li>
                            <li><span><a href="building-documents.php">Building Documents </span>></a><i
                                    class="flaticon-paper-plane"></i></li>
                            <li><span><a href="society-documents.php">Society Documents </span></a><i
                                    class="flaticon-paper-plane"></i></li>
                        </ul>
                    </div>
