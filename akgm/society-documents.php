                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <button type="submit" class="default-btn btn"><a
                                                    href="assets/images/pdf/Society-registration-certificate21-9-2016.pdf" style="
                                                color: #fff;
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            Register of Office Bearers and Members of the Governing Bodies 
                                        </button>
                                    </h2>
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <button type="submit" class="default-btn btn"><a
                                                    href="assets/images/pdf/Governing-Body.pdf" style="
                                                color: #fff;
                                            "> Download<i class="flaticon-paper-plane"></i></a></button>
                                        </div>
                                    </div>
