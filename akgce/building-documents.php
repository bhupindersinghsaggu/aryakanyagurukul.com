          ...
          <div class="accordion" id="accordionExample">
              ...
              <div id="collapseThree" class="collapse show" data-bs-parent="#accordionExample">
                <div class="card-body">
                  <h4 style="color: #ff7350; padding-top: 20px">
                    <a href="img/docs/bulding-completion-certificate.pdf"> View</a>
                  </h4>
            ...
            <div class="card">
              ...
              <div id="collapseThree" class="collapse show" data-bs-parent="#accordionExample">
                <div class="card-body">
                  <h4 style="color: #ff7350; padding-top: 20px">
                    <a href="img/docs/Land_Title_21-9-2016.pdf"> View</a>
                  </h4>
            ...
            <div class="card">
              ...
              <div id="collapseThree" class="collapse show" data-bs-parent="#accordionExample">
                <div class="card-body">
                  <h4 style="color: #ff7350; padding-top: 20px">
                    <a href="img/docs/Land-order-21-9-2016.pdf"> View</a>
                  </h4>
