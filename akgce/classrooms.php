        ...
        <div class="row justify">
            <div class="col-lg-8">
                ...
                <div class="details__content-img">
                    <img src="img/bg/couress-img-2.jpg" alt="contact-bg-an-01">
                    ...
                    <div align="justify"><strong>Class room Ethics :-</strong>
                      
                        <ul type="square">
                            <li>Passion for teaching learning and Research</li>
